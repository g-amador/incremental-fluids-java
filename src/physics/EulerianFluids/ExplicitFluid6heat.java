...
import static physics.EulerianFluids.ExplicitFluid6heat.CellType.CELL_FLUID;
import static physics.EulerianFluids.ExplicitFluid6heat.CellType.CELL_SOLID;
 ...
 */
class ExplicitFluid6heat {

    static final Logger log = getLogger("ExplicitFluid6heat");
    ...
    public static void main(String args[]) {
        ...
        double densitySoot = 0.1; /* You can make this larger to get heavy smoke */

        double diffusion = 0.01;
        double timestep = 0.005;

        boolean renderHeat = true; /* Set this to false to disable heat rendering */

        ArrayList<A_SolidBody> bodies = new ArrayList<>();
        bodies.add(new SolidBox(0.3, 0.6, 0.1, 0.5, -PI * 0.05, 0.0, 0.0, 0.0));
