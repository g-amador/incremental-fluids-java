...
import static physics.EulerianFluids.ExplicitFluid7variableDensity.CellType.CELL_FLUID;
import static physics.EulerianFluids.ExplicitFluid7variableDensity.CellType.CELL_SOLID;
 ...
 */
class ExplicitFluid7variableDensity {

    static final Logger log = getLogger("ExplicitFluid7variableDensity");
    ...
    public static void main(String args[]) {
        ...
        double densitySoot = 1.0; /* You can make this smaller to get lighter smoke */
    ...
    static class FluidQuantity {
         ...
         */
        private Stack<Integer> freeNeighbour(int idx, Stack<Integer> border, int mask) {
            _mask[idx] &= ~mask;
    ...
    static class FluidSolver {
         ...
         * respectively
         */
        private void addInflow(double x, double y, double w, double h, double d, double t, double u, double v) {
            ...
            try (BufferedWriter output = new BufferedWriter(new FileWriter(destination))) {
                ...
                for (int y = 0; y < _h; y++) {
                    for (int x = 0; x < _w; x++) {
                        ...
                        if (renderHeat) {
                            double t = (_t.getSrc(x, y) - _tAmb) / 700.0;
                            t = min(max(t, 0.0), 1.0);
